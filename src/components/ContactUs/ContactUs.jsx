      ...
      <div className={styles.container}>
        ...
        <ul className={styles.contacts__details}>
          <li className={styles.contacts__detail}>
            ...
            <a  className={styles.contacts__detailLink} href="tel:+380981234567" >
              <PhoneIcon id='svg' />
              38 (098) 12 34 567
            </a>
            <a  className={styles.contacts__detailLink} href="tel:+380931234567" >
              <PhoneIcon id='svg' />
              38 (093) 12 34 567
            </a>
          </li>
          <li className={styles.contacts__detail}>
            ...
            <a  className={styles.contacts__detailLink} href="mailto:office@ecosolution.com">
              <EmailIcon id='svg' />
          ...
          <li className={styles.contacts__detail}>
            ...
            <a className={styles.contacts__detailLink} 
          ...
          <li className={styles.contacts__detail}>
            ...
            <div className={styles.contacts__socialWrap}>
              <a className={styles.contacts__socialIcon} href='https://www.facebook.com/' target='_blank' rel='noopener noreferrer nofollow' >
                <FbIcon id='svg' />
            </a>
            <a className={styles.contacts__socialIcon} href='https://www.instagram.com/' target='_blank' rel='noopener noreferrer nofollow' >
